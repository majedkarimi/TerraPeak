      ...
      <section className="bg-gradient-to-br from-green-50 to-green-100 border-b border-green-200">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
          <div className="text-center max-w-3xl mx-auto">
            <h1 className="text-4xl sm:text-5xl font-bold text-gray-900 mb-4">Browse Terraform Modules</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="/#quickstart" className="text-gray-600 hover:text-green-600">
                    Quickstart
                  </a>
                </li>
                <li>
                  <a href="https://github.com/aliharirian/TerraPeak" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600">
                    GitHub
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="https://github.com/aliharirian/TerraPeak/issues" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600">
                    Issues
                  </a>
                </li>
              </ul>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                ...
                <li>
                  <a href="https://github.com/aliharirian/TerraPeak/blob/main/LICENSE" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-green-600">
                    License
                  </a>
                </li>
              </ul>
